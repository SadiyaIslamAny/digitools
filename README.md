...
4.  3 Features about my project: 
     ...
     * Interactive Cart: Add or remove products dynamically.

5. Optional Features: 
    * Clicking on a product increases the Navbar cart count, and clicking “Proceed to Checkout”     clears the cart.
    * Clicking the “Buy Now” button shows an “Added to cart” message.
